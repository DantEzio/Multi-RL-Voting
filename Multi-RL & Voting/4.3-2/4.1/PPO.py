...
class PPO:
    def __init__(self, env, ep, batch, num_rain, t='ppo2',raindata='test'):
        self.t = t
        self.ep = ep
    ...
    def _build_actor(self, name, trainable):
        with tf.compat.v1.variable_scope(name,reuse=tf.compat.v1.AUTO_REUSE):
            ...
            mu = (self.bound_high-self.bound_low) * tf.layers.dense(x, self.action_size, tf.nn.tanh, trainable=trainable,
